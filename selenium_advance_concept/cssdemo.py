...
driver.find_element(By.CSS_SELECTOR, "#citiCard2").send_keys("5656")
driver.find_element(By.CSS_SELECTOR, "#citiCard3").send_keys("8887")
driver.find_element(By.CSS_SELECTOR, "#citiCard4").send_keys("9998")
