...
# (action.click(driver.find_element(By.NAME, "q")).key_down(Keys.SHIFT).pause(1).send_keys("Hello World").key_up(
#     Keys.SHIFT).send_keys(Keys.ARROW_DOWN).send_keys(Keys.ARROW_DOWN).send_keys(Keys.ARROW_DOWN).pause(1).send_keys(
#     Keys.ENTER).perform()
#  )
import time
